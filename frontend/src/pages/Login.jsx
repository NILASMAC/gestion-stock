...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', fontFamily: "'Inter', sans-serif" }}>
      {/* Panneau gauche décoratif - CORRIGÉ : un seul display */}
      <div style={{ flex: 1, background: 'linear-gradient(135deg,#1e3a5f 0%,#0f172a 100%)', flexDirection: 'column', justifyContent: 'center', padding: '60px', display: 'none' }}>
      </div>
      ...
      <div style={{ width: '100%', maxWidth: 480, margin: 'auto', padding: '40px 32px' }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 56, height: 56, background: '#3b82f6', borderRadius: 16, marginBottom: 20 }}>
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="white">
              <path strokeWidth="2" strokeLinecap="round" d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/>
        ...
        {error && (
          <div style={{ background: '#450a0a', border: '1px solid #991b1b', borderRadius: 8, padding: '12px 16px', marginBottom: 20, color: '#fca5a5', fontSize: 14 }}>
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 18 }}>
            <label style={{ display: 'block', color: '#94a3b8', fontSize: 13, fontWeight: 500, marginBottom: 7 }}>Mot de passe</label>
            <input
              type="password"
              value={form.password}
